...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/td_14'))

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'Booking for granny')

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/button_Book Appointment'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_CURA Healthcare Service/section_Appointment Confirmation           _5b3155'), 
    0)
